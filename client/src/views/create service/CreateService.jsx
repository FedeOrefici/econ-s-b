...
const CreateService = () => {
  ...
  return (
    ...
    <div className="w-full h-screen">
        <form className="w-2/3 h-screen rounded flex items-center justify-center flex-col mx-auto text-white">
          ...
          <button className="bg-slate-300 text-black w-[180px] rounded py-2 hover:bg-slate-400 ">create</button>
        </form>
    </div>
    </>
  )
