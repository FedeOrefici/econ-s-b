...
const Card = ({product}) => {
  ...
  return (
    <>
      <div key={product?._id} className="border w-[300px] h-[400px] flex items-center justify-center flex-col gap-10 rounded cursor-pointer hover:scale-105 hover:transition-transform" style={{backgroundImage: `url(${product?.photo})`, backgroundSize:'cover', backgroundPosition:'center'}}>
