  ...
  return (
    <div>
      <Navbar />
        ...
        {
          <div className="bg-slate-800 w-3/4 h-3/4 mx-auto border rounded p-4 flex" key={product?._id}>
            <img src={profile} className="w-[500px] h-[670px] shadow-lg" />
            <div className="flex flex-col justify-center w-[900px] h-[670px] bg-slate-50">
              <div className="flex flex-col p-10">
                ...
                <p className="font-bold py-2 mt-4 w-1/2 text-slate-900 px-2">${product?.price}</p>
              </div>
