  ...
  return (
      ...
      <div onClick={handleOpen} className="flex items-center justify-center gap-4 px-4 py-4 bg-gray-50 w-[250px] h-[50px] cursor-pointer">
        ...
        <div className="flex text-gray-900">
            ...
            {openOptions ? (<div className="bg-white text-center w-[250px] top-[75px] left-[674px] absolute">
              <ul className="py-2 flex flex-col items-center justify-center">
                ...
                <NavLink to='/myServices' className="py-2 hover:bg-gray-300 w-full">Mi services</NavLink>
                <NavLink onClick={logoutClean} className="py-2 hover:bg-gray-300 w-full">Logout</NavLink>
              </ul>
            </div>) : null}
        </div>
    </div>
